...
<p><h2><a href="publicposts.php?post=<?php echo $post_id; ?>"><?php echo $post_title; ?></a></h2></p>
            ...
            <hr>
            <ul class="pager">
          <li class="previous"><a href="#" style="background-color: blue; color: white;"><span class="glyphicon glyphicon-arrow-left"></span> Older</a></li>
          <li class="next"><a href="#" style="background-color: blue; color: white;">Newer <span class="glyphicon glyphicon-arrow-right"></span></a></li>
        </ul>
          </div>
